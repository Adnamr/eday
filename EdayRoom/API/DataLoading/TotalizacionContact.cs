...
namespace EdayRoom.API.DataLoading
{
    ...
    public class TotalizacionContact
    {
        public IQueryable<TotalizacionContactAlertMessage> MensajesAlerta;
        ...
        public int? TotalizacionIdParent { get; set; }
        ...
        //Totalizacion Stats
        public int TotalizacionTimelineId { get; set; }
        ...
        //public IQueryable<TotalizacionCandidatoValue> LastValues { get; set; }
        //public IQueryable<TotalizacionCandidatoValue> PreviousValues { get; set; }

        public int LastTotalizacionId { get; set; }
        ...
        [ScriptIgnore]
        public QuickCountAlerta LinqTotalizacionAlertaObjQC
        {
            set
            {
        ...
        [ScriptIgnore]
        public TotalizacionAlerta LinqTotalizacionAlertaObj
        {
            set
            {
        ...
        [ScriptIgnore]
        public EntityCollection<TotalizacionAlertaMessage> LinqTotalizacionAlertaMessagesObj
        {
            set
            {
                if (value != null)
        ...
        [ScriptIgnore]
        public EntityCollection<QuickCountAlertaMessage> LinqTotalizacionAlertaMessagesObjQC
        {
            set
            {
                if (value != null)
