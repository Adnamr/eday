        ...
        return this.each(function() {
            ...
            $(this).bind(settings.event, function(e) {
                ...
                if (settings.loadurl) {
                    ...
                    $.ajax({
                        type: settings.loadtype, url: settings.loadurl, data: loaddata, async: false,
                ...
                if ('cancel' == settings.onblur) {
                    input.blur(function(e) { t = setTimeout(function() { reset.apply(form, [settings, self]); }, 500); });
                } else if ('submit' == settings.onblur) {
                    input.blur(function(e) { t = setTimeout(function() { form.submit(); }, 200); });
                } else if ($.isFunction(settings.onblur)) {
                    input.blur(function(e) { settings.onblur.apply(self, [input.val(), settings]); });
                } else {
