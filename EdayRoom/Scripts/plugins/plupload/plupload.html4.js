            ...
            f.bind("Init", function(p) {
                ...
                p.bind("Refresh", function(y) {
                    ...
                    if (F) {
                        ...
                        if (B) {
                            b.addEvent(A, "mouseover", function() { b.addClass(F, B); }, y.id);
                            b.addEvent(A, "mouseout", function() { b.removeClass(F, B); }, y.id);
                        }
                        if (C) {
                            b.addEvent(A, "mousedown", function() { b.addClass(F, C); }, y.id);
                            b.addEvent(a.body, "mouseup", function() { b.removeClass(F, C); }, y.id);
                        }
                    }
                });
