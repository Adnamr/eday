(function(f, a, c, g, e) {
    ...
    g.widget("ui.plupload", {
        contents_bak: "",
        runtime: null,
        options: { browse_button_hover: "ui-state-hover", browse_button_active: "ui-state-active", dragdrop: true, multiple_queues: true, buttons: { browse: true, start: true, stop: true }, autostart: false, sortable: false, rename: false, max_file_count: 0 },
        ...
        clearQueue: function() { this.uploader.splice(); },
        getUploader: function() { return this.uploader; },
        refresh: function() { this.uploader.refresh(); },
        ...
        _enableRenaming: function() {
            ...
            g(".plupload_file_name span", this.filelist).live("click", function(o) {
                ...
                m.next().val(j).focus().blur(function() { m.show().next().remove(); }).keydown(function(q) {
                    var p = g(this);
        ...
        _enableSortingList: function() {
            ...
            g("tbody", this.filelist).sortable({
                ...
                helper: function(l, k) { return k.clone(true).find("td:not(.plupload_file_name)").remove().end().css("width", "100%"); },
                stop: function(p, o) {
                    var l, n, k, m = [];
                    g.each(g(this).sortable("toArray"), function(q, r) { m[m.length] = i.uploader.getFile(r); });
                    m.unshift(m.length);
                    m.unshift(0);
        ...
        notify: function(j, k) {
            ...
            i.addClass("ui-state-" + (j === "error" ? "error" : "highlight")).find("p .ui-icon").addClass("ui-icon-" + (j === "error" ? "alert" : "info")).end().find(".plupload_message_close").click(function() { i.remove(); }).end();
