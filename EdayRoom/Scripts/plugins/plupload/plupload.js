...
(function() {
    ...
    var g = {
        ...
        xmlEncode: function(n) { return n ? ("" + n).replace(l, function(o) { return a[o] ? "&" + a[o] + ";" : o; }) : n; },
        toArray: function(p) {
            var o, n = [];
        ...
        g.extend(this, {
            ...
            init: function() {
                ...
                if (typeof(q.preinit) == "function") {
                    ...
                    g.each(q.preinit, function(C, B) { z.bind(B, C); });
                }
                ...
                if (typeof(q.init) == "function") {
                    ...
                    g.each(q.init, function(C, B) { z.bind(B, C); });
                }
            },
            ...
            hasEventListener: function(u) { return !!o[u.toLowerCase()]; },
            bind: function(u, w, v) {
                var x;
                u = u.toLowerCase();
                x = o[u] || [];
            ...
            unbindAll: function() {
                var u = this;
                g.each(o, function(w, v) { u.unbind(v); });
            },
            destroy: function() {
