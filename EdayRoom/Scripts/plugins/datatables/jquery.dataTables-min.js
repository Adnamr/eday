    ...
    $.fn.dataTable = function(oInit) {
        ...
        this.fnUpdate = function(mData, mRow, iColumn, bRedraw, bAction) {
            ...
            if ($.isArray(mData) && typeof mData == "object") {
                ...
                if (mData !== null && typeof mData == "object") {
        ...
        function _fnAjaxUpdate(oSettings) {
            if (oSettings.bAjaxDataGet) {
                ...
                _fnServerParams(oSettings, aoData);
                oSettings.fnServerData.call(oSettings.oInstance, oSettings.sAjaxSource, aoData, function(json) { _fnAjaxUpdateDraw(oSettings, json); }, oSettings);
                return false;
            } else {
                return true;
            }
        ...
        function _fnCalculateColumnWidths(oSettings) {
            ...
            if (iColums == oHeaders.length && iUserInputs === 0 && iVisibleColumns == iColums && oSettings.oScroll.sX === "" && oSettings.oScroll.sY === "") {
                ...
                if (oSettings.nTFoot !== null) {
                    ...
                    _fnApplyToChildren(function(n) { n.style.width = ""; }, nCalcTmp.getElementsByTagName("tr"));
                }
