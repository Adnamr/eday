...
(function() {
    ...
    n(y.prototype, {
        ...
        print: function() {
            ...
            if (!a.isPrinting)
                a.isPrinting =
                    !0, k(f, function(a, b) { if (a.nodeType === 1) c[b] = a.style.display, a.style.display = "none"; }), e.appendChild(b), D.print(), setTimeout(function() {
                        d.appendChild(b);
        ...
        contextMenu: function(a, b, c, d, e, f) {
            ...
            if (!j)
                i[q] = j = r("div", { className: "highcharts-" + a }, { position: "absolute", zIndex: 1E3, padding: l + "px" }, i.container), m = r("div",
                    null, n({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, g.menuStyle), j), w = function() { t(j, { display: "none" }); }, z(j, "mouseleave", w), k(b, function(a) {
                        if (a) {
