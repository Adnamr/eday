...
var HighchartsAdapter = function() {
    ...
    return {
        init: function(c) {
            if (g)
                Effect.HighchartsTransition = Class.create(Effect.Base, {
                    ...
                    finish: function() { delete this.element._highchart_animation[this.key]; }
                });
        },
        adapterRun: function(c, a) { return parseInt($(c).getStyle(a), 10); },
        ...
        addEvent: function(c, a, b) { c.addEventListener || c.attachEvent ? Event.observe($(c), HighchartsAdapter.addNS(a), b) : (HighchartsAdapter._extend(c), c._highcharts_observe(a, b)); },
        animate: function(c, a, b) {
            var d, b = b || { };
            b.delay = 0;
            b.duration = (b.duration || 500) / 1E3;
            b.afterFinish = b.complete;
            if (g) for (d in a) new Effect.HighchartsTransition($(c), d, a[d], b);
            else {
        ...
        each: function(c, a) { $A(c).each(a); },
        offset: function(c) { return $(c).cumulativeOffset(); },
        ...
        grep: function(c, a) { return c.findAll(a); },
        map: function(c, a) { return c.map(a); },
        merge: function() {
        ...
        _extend: function(c) {
            c._highcharts_extended || Object.extend(c, {
                ...
                _highcharts_observe: function(a, b) { this._highchart_events[a] = [this._highchart_events[a], b].compact().flatten(); },
                _highcharts_stop_observing: function(a, b) { a ? b ? this._highchart_events[a] = [this._highchart_events[a]].compact().flatten().without(b) : delete this._highchart_events[a] : this._highchart_events = { }; },
