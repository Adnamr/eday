...
testigos = {
    ...
    init: function() {
        ...
        testigos.initUploader(url, uploadCallback);
        $.getJSON('/Centros/GetProgress', function(data) {
            if (data.IsActive) {
                testigos.startProgressGetter();
            }
        });
    },
    ...
    getUploadUrl: function() {
        alert('hey');
        return 'http://www.i-google-buzz.com';
    },
    initUploader: function(url) {
        ...
        uploader.bind('BeforeUpload', function(up, file) {
            up.settings.url = url + "?type=" + $("#testigoType").val();
        });
